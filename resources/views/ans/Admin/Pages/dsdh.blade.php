...
<body style="background-color: #ecf0f1; padding:0;margin 0;">
    <div class="row" style="padding: 0px; margin: 0px;">
        ...
        <div class="col-sm-12 banner" style="padding-top: 1em;">
                ...
                <div class="col-sm-12">
                    <form method="GET" action="{{url('admin/lochoadon')}}" style="margin-bottom:10px;">
                        <select class="select-date colorbg custom-select" name="year" id="year" size="1"></select>
                        <select class="select-date colorbg custom-select" name="month" id="month" size="1"></select>
                        <select class="select-date colorbg custom-select" name="day" id="day" size="1">
